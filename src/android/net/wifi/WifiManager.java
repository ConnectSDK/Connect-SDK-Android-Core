...
//    }
    ...
    public class MulticastLock { // multicast lock is used on android to save power. not required on a server
        MulticastLock() {
            /* throw new RuntimeException("Stub!"); */ }
...
//    public android.net.wifi.WifiManager.WifiLock createWifiLock(int lockType, java.lang.String tag) {
//        throw new RuntimeException("Stub!");
//    }
//
