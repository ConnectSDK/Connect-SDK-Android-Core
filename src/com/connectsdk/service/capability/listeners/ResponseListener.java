...
public interface ResponseListener<T> extends ErrorListener {
     ...
     * It is also possible that responseObject will be <code>null</code> for operations that don't require data to be returned (move mouse, send key code, etc).
     * 
     * @param responseObject Response object, can be any number of object types, depending on the protocol/capability/etc, even <code>null</code>
     */
    abstract public void onSuccess(T responseObject);
}
